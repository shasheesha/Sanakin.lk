...
//     echo " " . $_SESSION['email'] . "<br>" . $_SESSION['newPassword'] . "";
...
<body>
    ...
    <div class="offcanvas offcanvas-end sign-up-canvas" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="container">
                <div class="sign-up-body">
                    <form class="step s1" id="sec1" action="" method="POST" required>
                        ...
                        <div class="feilds">
                            <input type="email" class="t-feild" name="newEmail" id="newEmail" placeholder="Email Address">
                            <input type="password" class="t-feild" name="newPassword" id="newPassword" placeholder="Create Password" onkeyup="checkPasswordMatch();">
                            <input type="password" class="t-feild" name="confirmPassword" id="confirmPassword" placeholder="Confirm Password" onkeyup="checkPasswordMatch();">
                        </div>
                    ...
                    <form class="step s2" id="sec2" style="display: none;" action="" method="POST" required>
