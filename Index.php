  ...
  <div class="col-lg-12 py-2">
            ...
            <div class="carousel-item h-100 active">
              <div class="carousel-caption banner-content">
                <div class="row hero-content">
                  <h1 class="main-title">Find the Best Products<br>with <span class="primarycolor-text1">Reliability</h1>
                  <div class="SearchBox">
              ...
              <img src="uploads/banner/banner1.jpg" class="d-block w-100  h-100" alt="bannner1">
            </div>
          </div>
    ...
    <div class="container px-4 px-lg-5 mt-5">
      ...
      <div class="row gx-4 gx-lg-4 row-cols-md-3 row-cols-xl-4 ">
        <div class="col-2 ca-1">
          <h5 class ="top-ca">Tech</h5>
          <!-- category image-->
          <img class="card-img-top w-100 book-cover" src="uploads/categories/lap 1.png" alt="..." />
        </div>
      </div>
    </div>
    ...
    <div class="container px-4 px-lg-5 mt-5">
      ...
      <div class="row gx-4 gx-lg-4 row-cols-md-3 row-cols-xl-4 ">
        <div class="col-2 ca-1">
        <img class="card-img-top w-100 book-cover" src="uploads/categories/lap 1.png" alt="..." />
          <h5 class ="top-ca">Product Name</h5>
          <h6 class ="top-ca">RS.100,000.00</h5>
    ...
    <!-- Categories Start -->
    <div class="container px-4 px-lg-5 mt-5">
        <h3><span>Choose by Shops</span></h3>
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="uploads/shops/Vector.png" alt="">
                        </div>
    ...
    <div class="row">
      <div class="container px-4 px-lg-5 mt-5">
        <div id="carouselExampleControls" class="carousel slide bg-dark" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item h-100 active">
              <img src="uploads/poster/poster1.png" class="d-block w-100  h-100" alt="bannner1">
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="col-md-6">
                <div class="product-offer mb-30" style="height: 300px;">
                    ...
                    <div class="offer-text">
                        <h3 class="text-white mb-3">Product Category</h3>
